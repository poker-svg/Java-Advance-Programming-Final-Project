 ...
 * @LastEditTime: 2023-01-16 17:36:36
 * @LastEditors: Xu YangXin
 * @Description: 此类代表蛇精，初始武器为棒球棍
 * @FilePath: \jfp-poker-svg\src\main\java\cn\edu\nju\cs\game\world\creature\goblins\Snake.java
...
public class Snake extends Goblin{
    public static final char GLYPH = Tile.SNAKER.glyph();
    public static final Color COLOR = Tile.SNAKER.color();
    ...
    public Snake(World world){
        super(world, Snake.GLYPH, Snake.COLOR, Snake.MAX_HP, Snake.ATTACK_VALUE,
        Snake.DEFENSE, Snake.VISION_RADIUS, Snake.MOVE_SPEED_INTERVAL);
